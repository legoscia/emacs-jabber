...
Patch0: %name-%version-%release-alt-personal-alerts.patch
Patch1: %name-%version-%release-alt-activity.patch
Patch2: %name-%version-%release-alt-docs.patch
Patch3: %name-%version-%release-alt-osd.patch
